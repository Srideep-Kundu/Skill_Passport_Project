        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              className="w-full h-full bg-white dark:bg-[#111821] border border-slate-200 dark:border-white/[0.12] rounded-3xl shadow-2xl shadow-black/50 flex flex-col overflow-hidden text-slate-900 dark:text-[#f1f0e8]"
            >
              {/* Header */}
              <div className="p-4 bg-slate-50 dark:bg-[#151921] border-b border-slate-200 dark:border-white/[0.08] flex items-center justify-between shrink-0">
              ...
              <div className="px-4 py-2 bg-slate-50 dark:bg-[#151921] border-t border-slate-200/80 dark:border-white/[0.06] flex gap-1.5 overflow-x-auto no-scrollbar text-[10px] shrink-0">
              ...
              {/* Input Bar */}
              <div className="p-3 bg-white dark:bg-[#111821] border-t border-slate-200 dark:border-white/[0.08] shrink-0">
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                    void handleSend();
