...
// =========================================================================
// Collaboration & Funding Hub and Training Planner Types
// =========================================================================

export interface SocietySpeaker {
  name: string;
  topic?: string;
  org?: string;
}

export interface SocietyPreviousCollab {
  year?: string;
  title: string;
  participants?: number;
  outcome?: string;
...
export interface SocietyContactDetails {
  email?: string;
  phone?: string;
  regional_chair?: string;
  coordinator?: string;
...
export interface ProfessionalSociety {
  ...
  funding_sponsorship_details?: string | null;
  expert_speakers: SocietySpeaker[];
  previous_collaborations: SocietyPreviousCollab[];
  contact_details: SocietyContactDetails;
  proposal_requirements?: string | null;
  is_active: boolean;
  created_at: string;
}
...
export interface FundingRecommendation {
  ...
  relevant_student_gap?: string | null;
}
...
export interface FacultyProposal {
  ...
  status: "draft" | "submitted" | "under_review" | "accepted" | "rejected" | "collaboration_active";
...
export interface MarketingKit {
  ...
  whatsapp_announcement: string;
  registration_page_copy: string;
}
...
export interface TrainingProgram {
  ...
  capacity_diagnostic?: CapacityDiagnostic | null;
  budget_breakdown?: Record<string, number> | null;
  ...
  notice_status: "GOOD" | "WARNING" | "CRITICAL";
  marketing_kit?: MarketingKit | null;
